      ...
      <section id="hero" className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.profileWrap}>
            <img src="/photo.jpg" alt={data.name} className={styles.profileImg} onError={e=>{e.target.style.display="none";e.target.nextSibling.style.display="flex";}}/>
      ...
      <section id="about" className={styles.section}>
        ...
        <div className={styles.terminalCard}>
          ...
          <div className={styles.terminalBody}>
            <div className={styles.aboutRow}><span className={styles.aboutIcon}>📍</span><div><div className={styles.aboutLabel}>location</div><div className={styles.aboutValue}>{data.location}</div></div></div>
            <div className={styles.aboutRow}><span className={styles.aboutIcon}>📅</span><div><div className={styles.aboutLabel}>years_active</div><div className={styles.aboutValue}>2024 – Present</div></div></div>
            <div className={styles.aboutRow}><span className={styles.aboutIcon}>💼</span><div><div className={styles.aboutLabel}>status</div><div className={styles.statusBadge}><span className={styles.statusDot}></span>{data.status}</div></div></div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.eduGrid}>
          {data.education.map((e,i)=>(
            <div key={i} className={styles.eduCard}>
              <div className={styles.eduIcon}>{e.emoji}</div>
              <div><div className={styles.eduCmd}>$ cat ./{e.type.toLowerCase().replace(/ /g,"-")}.md</div><div className={styles.eduTitle}>{e.title}</div><div className={styles.eduType}>{e.type}</div></div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="contact" className={styles.section}>
        ...
        <div className={styles.contactGrid}>
          ...
          <div className={styles.contactForm}>
            ...
            <div className={styles.formGroup}><label className={styles.formLabel}>&gt; name</label><input type="text" className={styles.formInput} placeholder="John Doe"/></div>
            <div className={styles.formGroup}><label className={styles.formLabel}>&gt; email</label><input type="email" className={styles.formInput} placeholder="you@example.com"/></div>
            <div className={styles.formGroup}><label className={styles.formLabel}>&gt; message</label><textarea className={styles.formInput} placeholder="Tell me about your project..." rows={5}></textarea></div>
